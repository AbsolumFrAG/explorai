import { faBug, faCircleInfo, faClockRotateLeft, faMoneyBillWave } from "@fortawesome/free-solid-svg-icons";
    ...
    const renderSection = () => {
        switch (accountSection) {
            ...
            default:
                return (
                    <>
                        <h2 className="mb-8 text-5xl font-bold text-gray-800">Sélectionnez une section de compte</h2>
                    </>
                );
        }
    };
