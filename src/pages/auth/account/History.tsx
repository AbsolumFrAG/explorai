...
import { deleteItinerary, retrieveItineraries } from "../../../utils/firestoreFunctions";
...
const History: React.FC = () => {
    ...
    return (
        <div>
            <h2 className="mb-8 text-3xl font-bold text-gray-800 sm:text-5xl">Itinéraires précédents</h2>
            {loading ? (
                ...
                <li className="flex items-center justify-between rounded-2xl border border-gray-300 border-opacity-20 bg-white px-8 py-4 shadow-xl">
                    <div className="space-y-2">
                        <p className=" rounded-lg px-4 py-2 text-xl font-medium text-gray-500">Aucun itinéraire trouvé</p>
                    </div>
                </li>
            ) : (
